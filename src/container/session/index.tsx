...
const Session = () => {
  return (
    <section
      className='flex min-h-screen w-screen flex-col items-center justify-center gap-4 bg-white pb-12 max-sm:py-44'
      id='session'
    >
      <p className='w-full text-center text-3xl font-bold uppercase sm:hidden'>session</p>
      <div className='mt-20 flex w-full flex-wrap justify-around gap-y-8 px-32 max-sm:px-4'>
        <div className='sessionGradient rainbowBorder relative h-[400px] w-[320px] shadow-2xl max-sm:hidden'>
