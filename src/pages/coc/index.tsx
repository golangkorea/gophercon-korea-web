    ...
    <Layout>
      <Content>
        <div className='max-sm:p-4'>
          ...
          . B) 대응 및 조치 행사에 참여하며, 다른 참여자 분께 어떠한 문제가 발생하거나 다른 참여자 분께서 문제에 처한
          것을 보셨거나, 불편 사항이 있으시면 GopherCon Korea 준비위원회(이하 준비위)에게 도움을 요청해 주세요. 위급한
          ...
          누가봐도 위급한 상황이라면 스태프에게 도움을 청함과 동시에 경찰, 소방서 등 관할 기관에 신고하여 적절한 조치가
          될 수 있도록 해 주세요. 사실 확인이 어려운 경우 심증만으로 피신고자나 단체에 조치를 취하기는 어렵습니다. 조치
          여부와 관계없이 위협을 느끼신다면 동행, 분리 등의 도움을 드릴 수 있습니다. GopherCon Korea 2023에서 위와 같은
          행동 강령을 어길 시에는 준비위원회에 의하여 주의 조치 다른 참가자와의 격리 조치 행사장 퇴장 조치
          사법기관으로의 인도 조치 혹은 위에 언급되지 않은 필요한 조치가 이루어질 수 있음을 공지드립니다.
        </div>
      </Content>
    </Layout>
  );
