...
export const SESSIONS: Session[] = [
  ...
  },
  {
    ...
    category: "Main Talk",
    description:
      "Go 언어 관련 강연에 참석하면 자주 들리는 질문이 있습니다. ‘Go 언어로는 무엇을 할 수 있나요?’ 이번 세션에서는 왜 Go 언어가 오픈소스에 기여할 수 있는 강력한 도구인지 이야기하고 Go 언어로 구현된 클라우드 네이티브 오픈소스들을 소개합니다. 더 나은 이해를 위해 데모 애플리케이션을 활용합니다. 이후 ‘오픈소스 컨트리뷰션 아카데미’, ‘LFX Mentorship’등 오픈소스 기여를 도와주는 국내외 여러 프로그램에 참여한 경험을 소개합니다.",
    speaker: {
      name: "박남규",
      company: "LitmusChaos",
      description:
