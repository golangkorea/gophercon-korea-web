...
const sponsorList: SponsorProps[] = [
  {
    ...
    desc: {
      ko: "Google Go 팀은 현대 소프트웨어 개발의 복잡성을 줄이고, 효율적인 성능을 제공하기 위해 Google에서 개발한 프로그래밍 언어인 Go(또는 Golang)를 설계 및 관리하는 팀입니다. Go는 고성능, 동시성, 그리고 간결한 문법을 자랑하며, 많은 대규모 애플리케이션과 시스템에서 널리 사용되고 있습니다. Google Go 팀은 개발자 커뮤니티와의 긴밀한 협력을 통해 언어의 발전과 생태계 확장에 기여하고 있으며, 특히 클라우드, 네트워크, 컨테이너화된 애플리케이션 개발에 강력한 지원을 제공합니다.\nGo 팀은 Go 언어의 안정성, 속도, 그리고 확장성을 지속적으로 개선하면서도 사용자의 피드백을 적극 반영하여 개발자 경험을 향상시키기 위해 노력하고 있습니다. 이 팀의 목표는 개발자들이 더욱 빠르고 효율적으로 소프트웨어를 구축할 수 있도록 돕는 것입니다.",
      en: "The Google Go Team is responsible for designing and maintaining the Go (also known as Golang) programming language, which was developed by Google to reduce the complexity of modern software development and provide efficient performance. Go is known for its high performance, concurrency, and clean syntax, making it a widely-used language in many large-scale applications and systems. The Google Go Team actively contributes to the growth and evolution of the language and its ecosystem, particularly in areas such as cloud computing, networking, and containerized application development.\nThe team continuously works to improve Go’s stability, speed, and scalability while also integrating feedback from the developer community to enhance the overall developer experience. Their mission is to empower developers to build software faster and more efficiently.",
    },
    link: "https://go.dev/",
  },
  {
    imgSrc: "logo_labs.png",
    grade: GOLD_GRADE,
    desc: {
  ...
  },
  {
    ...
    desc: {
      ko: "2005년 시작한 우분투 한국 커뮤니티는 Ubuntu Community Council 인증 공식 우분투 지역 커뮤니티 입니다. 온라인 커뮤니티 및 문서 서비스 제공, 각종 세미나와 컨퍼런스 개최, 우분투 및 관련 오픈소스 기술에 대한 그룹 스터디와 연구/개발 및 프로젝트 등 다양한 활동을 하고 있습니다.",
      en: "The Ubuntu Korean Community, founded in 2005, is an officially recognized Ubuntu Local Community (LoCo) by the Ubuntu Community Council. The community offers online forums and documentation services, organizes various seminars and conferences, and engages in group studies, research, development, and projects related to Ubuntu and associated open-source technologies.",
    },
  },
  {
