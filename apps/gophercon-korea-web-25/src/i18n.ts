    ...
    translation: {
      ...
      page_title: {
        ...
        not_found_messages: [
          ...
          "Are you lost, little gopher?",
          "go get a map",
          "404: Gopher not found.",
          "Looks like you've ventured into the unknown.",
          "Oops! This page is on a coffee break.",
      ...
      sponsorship_guide: {
        ...
        benefit_labels: {
          ...
          streaming: "Streaming Logo Exposure",
          souvenir: "Souvenirs",
        ...
        tiers1: [
          {
            ...
            benefits: {
              ...
              keynote: true,
              techtalk: "1 session (40-60 mins)",
              booth: "Large",
              mention: true,
              sns: "Exposure, sketch film provided",
              lounge: true,
              streaming: "Exposure, promo video shown",
              souvenir: true,
              tickets: "15 tickets",
              parking: "5 passes",
            },
      ...
      sponsorship_form: {
        ...
        event_overview_date: "Date: Between September and October 2025",
        ...
        about_gophercon_title: "GopherCon",
        about_gophercon_content:
          'Go language users are called "Gophers," and each year, Go communities worldwide host an annual event called GopherCon. Since it began in 2014, GopherCon has been held in countries across the globe, including the United States, Germany, the UK, China, Japan, Brazil, Israel, India, Canada, Italy, and Singapore. In Korea, we’re planning to host GopherCon Korea 2025 this coming September - October.',
  ...
  ko: {
    translation: {
      ...
      page_title: {
        ...
        not_found_messages: [
          "nil 포인터 역참조!",
          "패닉: 런타임 에러: 인덱스 범위를 벗어났습니다",
          "길을 잃으셨나요, 고퍼?",
          "go get a map 해보세요",
          "404: 고퍼를 찾을 수 없습니다.",
          "알 수 없는 영역으로 들어오셨네요.",
          "이런! 이 페이지는 잠시 쉬는 중입니다.",
          "에러: JSON 0번째 위치에 예기치 않은 토큰 <",
        ],
      },
      home: {
        title: "고퍼콘 코리아 2025",
        ...
        tiers1: [
          {
            ...
            benefits: {
              logo: "모든 매체 제공 (최상단)",
              keynote: true,
              techtalk: "1회 (40~60mins)",
              booth: "대형",
              mention: true,
              sns: "노출, 스케치 필름 제공",
              lounge: true,
              streaming: "노출, 홍보 영상 노출",
              souvenir: true,
              tickets: "15매",
              parking: "주차권 5매",
            },
      ...
      sponsorship_form: {
        ...
        event_overview_date: "일시: 2025년 9월 ~ 10월 중",
