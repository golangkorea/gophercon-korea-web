  ...
  en: {
    translation: {
      ...
      home: {
        ...
        date: "2025. 11. 09. (SUN)",
        venue: "COEX Magok, 4F, Le West Hall B",
      ...
      about: {
        ...
        venue: "Venue: COEX Magok, 4F, Le West Hall B",
      ...
      organizers: {
        ...
        preparatory_committee_list: [
          { name: "Hyeongjun Kang", role: "Preparatory Committee", avatar: "gopher-head" },
          { name: "Joungsik Kim", role: "Preparatory Committee", avatar: "gopher-head" },
          { name: "Hyowon Park", role: "Preparatory Committee", avatar: "gopher-head" },
          { name: "Mir Jung", role: "Preparatory Committee", avatar: "gopher-head" },
          { name: "Byungyoung Park", role: "Preparatory Committee", avatar: "gopher-head" },
          { name: "Seunghyun Lim", role: "Preparatory Committee", avatar: "gopher-head" },
          { name: "Jimin Han", role: "Preparatory Committee", avatar: "gopher-head" },
          { name: "Junsang Moon", role: "Preparatory Committee", avatar: "gopher-head" },
        ],
        artwork_credit:
      ...
      sponsorship_form: {
        ...
        event_overview_venue: "Venue: COEX Magok, 4F, Le West Hall B (143 Magokjungang-ro, Gangseo-gu, Seoul)",
        ...
        venue_name: "COEX Magok, 4F, Le West Hall B",
  ...
  ko: {
    translation: {
      ...
      organizers: {
        ...
        preparatory_committee_list: [
          { name: "강형준", role: "준비위원회", avatar: "gopher-head" },
          { name: "김정식", role: "준비위원회", avatar: "gopher-head" },
          { name: "박효원", role: "준비위원회", avatar: "gopher-head" },
          { name: "정미르", role: "준비위원회", avatar: "gopher-head" },
          { name: "박병영", role: "준비위원회", avatar: "gopher-head" },
          { name: "임승현", role: "준비위원회", avatar: "gopher-head" },
          { name: "한지민", role: "준비위원회", avatar: "gopher-head" },
          { name: "문준상", role: "준비위원회", avatar: "gopher-head" },
        ],
        artwork_credit:
